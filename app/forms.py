...
class Apply_form(forms.ModelForm):
    ...
    class Meta:
        model = Apply
        fields = ['f_name','l_name','gender','email_id','edu_name','edu_year','edu_collage_name','edu_marks','internship','project_name','project_link','img','resume']
    def __init__(self, *args, **kwargs):
        super(Apply_form, self).__init__(*args, **kwargs)
        self.fields['internship'].required = False
        self.fields['project_name'].required = False
        self.fields['project_link'].required = False
